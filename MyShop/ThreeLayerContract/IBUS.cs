...
namespace ThreeLayerContract
{
    public abstract class IBus
    {
        ...
        public abstract Task<System.ComponentModel.BindingList<Book>> GetBookByCategory(string _nameCategory);
        public abstract Task<System.ComponentModel.BindingList<Book>> GetDetailOrder(int Id);
        ...
        public abstract Task<System.ComponentModel.BindingList<Book>> loadListProduct(int Id);
        public abstract Task<System.ComponentModel.BindingList<Book>> LoadListProductWithCategory(string _nameCategory);
    }
}
